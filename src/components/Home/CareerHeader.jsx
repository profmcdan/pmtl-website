                    ...
                    <nav className='main-menu clearfix'>
                      ...
                      <div className='navbar-collapse collapse clearfix'>
                        <ul className='navigation clearfix'>
                          ...
                          <li>
                            <Link to={"/communication"}>Vacancy-for-Communication/Field Engineers</Link>
                          </li>
                           <li>
                            <Link to={"/mechanical"}>Vacancy-for-Mechanical /Mechatronics Engineer </Link>
                          </li>
                           <li>
                            <Link to={"/hardware"}>Vacancy-for-Hardware Design Engineers </Link>
                          </li>
                           <li>
                            <Link to={"/rf"}>Vacancy-for-RF & Microwave Engineers </Link>
                          </li>
                           <li>
                            <Link to={"/integration"}>Vacancy-for-Integration Engineers </Link>
                          </li>
                           <li>
                            <Link to={"/technician"}>Vacancy-for-Technicians </Link>
                          </li>
